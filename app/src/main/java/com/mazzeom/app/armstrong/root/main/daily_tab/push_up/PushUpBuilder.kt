 ...
 */
class PushUpBuilder(dependency: ParentComponent) : ViewBuilder<PushUpView, PushUpRouter, PushUpBuilder.ParentComponent>(dependency) {
   ...
   */
  fun build(parentViewGroup: ViewGroup): PushUpRouter {
  ...
  abstract class Module {
    ...
    companion object {
      ...
      internal fun router(
          component: Component,
          view: PushUpView,
          interactor: PushUpInteractor): PushUpRouter {
