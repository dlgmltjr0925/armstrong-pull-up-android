 ...
 */
class DailyTabBuilder(dependency: ParentComponent) : ViewBuilder<DailyTabView, DailyTabRouter, DailyTabBuilder.ParentComponent>(dependency) {
  ...
  abstract class Module {
    ...
    companion object {
      ...
      internal fun router(
          component: Component,
          view: DailyTabView,
          interactor: DailyTabInteractor): DailyTabRouter {
        return DailyTabRouter(view, interactor, component)
      }
    }
  ...
  interface Component : InteractorBaseComponent<DailyTabInteractor>, BuilderComponent {
