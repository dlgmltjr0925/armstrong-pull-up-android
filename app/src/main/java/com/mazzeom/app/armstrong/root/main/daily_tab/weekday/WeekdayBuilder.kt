 ...
 */
class WeekdayBuilder(dependency: ParentComponent) : ViewBuilder<WeekdayView, WeekdayRouter, WeekdayBuilder.ParentComponent>(dependency) {
   ...
   */
  fun build(parentViewGroup: ViewGroup): WeekdayRouter {
  ...
  abstract class Module {
    ...
    companion object {
      ...
      internal fun router(
          component: Component,
          view: WeekdayView,
          interactor: WeekdayInteractor): WeekdayRouter {
        return WeekdayRouter(view, interactor, component)
      }
    }
  ...
  interface Component : InteractorBaseComponent<WeekdayInteractor>, BuilderComponent {
